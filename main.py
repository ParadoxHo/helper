...
# Отключаем телеметрию ChromaDB (убирает ошибки)
os.environ["CHROMA_TELEMETRY_ENABLED"] = "false"

import chromadb
from fastembed import TextEmbedding

# --- Правильные настройки CORS (включая новый домен) ---
ALLOWED_ORIGINS = [
    "https://assistics.netlify.app",
    "https://pagggge.vercel.app",
    "https://assistics.vercel.app",   # ← добавлено
    "http://localhost:8000",
    "http://127.0.0.1:8000"
]
...
"""
    ...
    # Если контекст пуст, а устройство определено – быстрый ответ
