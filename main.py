...
# Wyłącz telemetrię ChromaDB
os.environ["CHROMA_TELEMETRY_ENABLED"] = "false"

import chromadb
from fastembed import TextEmbedding

# --- Lista dozwolonych domen CORS (można dostosować) ---
ALLOWED_ORIGINS = ["*"]  # Na czas testów, później można zawęzić

# --- Lifespan do zarządzania zasobami ---
@asynccontextmanager
...
# Słownik do mapowania nazw urządzeń na słowa kluczowe w nazwach plików
DEVICE_KEYWORDS = {
