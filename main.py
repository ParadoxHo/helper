...
# --- Правильная настройка CORS (только через middleware) ---
ALLOWED_ORIGINS = [
    "https://assistics.netlify.app",
    "https://pagggge.vercel.app",
    # При необходимости можно добавить localhost для тестов
    "http://localhost:8000",
    "http://127.0.0.1:8000"
]
...
# Словарь ключевых слов для определения типа устройства по имени файла
DEVICE_KEYWORDS = {
