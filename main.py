...
Jeśli kontekst mówi: "Aby zmienić kod w Rosslare, naciśnij [*] i wprowadź kod mistrza, a następnie [9] i nowy kod.", to odpowiedź powinna brzmieć:
1️⃣ Naciśnij [*].
2️⃣ Wprowadź kod mistrza.
3️⃣ Naciśnij [9].
4️⃣ Wprowadź nowy kod.
5️⃣ Potwierdź [#].
...
3. Jeśli instrukcja wymaga sprawdzenia zasilania, napisz po prostu "Sprawdź zasilanie".
4. Nie dodawaj żadnych wstępów, podsumowań ani wyjaśnień technicznych.
5. Nie używaj terminów takich jak "na podstawie instrukcji", "z dokumentacji" itp.
6. Odpowiedź powinna zawierać maksymalnie 5 kroków.
7. Jeśli kontekst nie zawiera odpowiedzi, napisz tylko: "Nie znalazłem tej informacji w instrukcjach. Proszę skontaktować się z serwisem."
"""
                ...
                try:
                    resp = await client.post(
                        ...
                        json={
                            ...
                            "messages": history,
                            "temperature": 0.1,          # jeszcze niższa temperatura
                            "max_tokens": 400,
                            "top_p": 0.9
                        },
                        timeout=30.0
