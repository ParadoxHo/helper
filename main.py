...
<body>
    ...
    <script>
        // Funkcja inicjalizacji - uruchamiana po załadowaniu strony
        window.addEventListener('load', function() {
            ...
            if (!messagesDiv) {
                console.error('Brak elementu chat-messages');
                return;
            }
            if (!input) {
                console.error('Brak elementu message-input');
                return;
            }
            if (!sendButton) {
                console.error('Brak elementu send-button');
                return;
            }
            if (!statusBadge) {
                console.error('Brak elementu status-badge');
                return;
            }
            ...
            // Funkcja dodawania wiadomości tymczasowej
...
Zawsze zaczynaj od diagnostyki: sprawdź zasilanie, kable, połączenia.`
            ...
            // Event listeners - DOPIERO TERAZ, gdy elementy istnieją
