...
<body>
    ...
    <script>
        (function() {
            ...
            // Funkcja, która wykona się gdy elementy będą dostępne
            function whenReady(callback) {
                ...
                // Если уже готово, вызываем сразу
                if (check()) return;
                
                // Иначе используем MutationObserver для отслеживания изменений в DOM
            ...
            whenReady(function(elements) {
                const { messagesDiv, input, sendButton, statusBadge } = elements;
